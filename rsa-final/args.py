...
arg_parser.add_argument('-n', '--hidden_layers', help='Configure hidden layers. Syntax: [<hidden_layer_1_neurons>, <hidden_layer_2_neurons>, ..., <hidden_layer_n_neurons>].', type=is_int_list, default=[10, 10])
...
arg_parser.add_argument('-l', '--learning_rates', help='List of learning rates that each model tested will use. Syntax: [<model_1_learning_rate>, <model_2_learning_rate>, ..., <model_n_learning_rate>]', type=is_float_list, default=[0.001, 0.01])
